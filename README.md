...
Un potenziometro collegato a +12V e GND crea la tensione di riferimento di 0.4V.
...
Pin 3 (+): Ingresso dal cursore centrale del potenziometro (0.4V).
Pin 2 (-): Collegato direttamente al Pin 6 (Feedback totale).
...
PARTITORE: Circuito a resistenze che riduce i 12V a 0.4V. L'uso del potenziometro permette di correggere le tolleranze delle resistenze per avere uno zero perfetto.
...
ERRORE DI CARICO: Inizialmente collegando il sensore direttamente alle resistenze, il voltaggio cambiava. SOLUZIONE: Inserimento dei Buffer per isolare i segnali.
...
IMPRECISIONE DELLO ZERO: Le resistenze fisse non davano esattamente 0.4V. SOLUZIONE: Utilizzo del potenziometro per una taratura fine del riferimento di offset.
